Feature: Arrived and waiting screen
    ...
    Scenario: 01. Check case verify info booking top srceen booking with setting show fare
        ...
        When I want to get info top screen of booking status arrived and waiting
        Then I should get the object response message matches with
            | response                                                                                                                                                                                       |
            | {"pickUp": "Da Nang International Airport, Hai Chau District, Da Nang, Vietnam", "destination": "Duy Tan University, Da Nang, Vietnam","iconNoshow": true,"fare": true, "paymentType": "Cash"} |
    ...
    #     Then I should get the object response message matches with
    #         | response                                                                                                                                                                                        |
    #         | {"pickUp": "Da Nang International Airport, Hai Chau District, Da Nang, Vietnam", "destination": "Duy Tan University, Da Nang, Vietnam","iconNoshow": true,"fare": false, "paymentType": "Cash"} |

    Scenario: 03. Check case verify info booking footer srceen
        Given Waiting open driver app succesfull
        And I want to register other account from app
            | platform | number     | country | appType   | verifyCode | ime             |
            | android  | 2055550001 | US      | passenger | 1211       | 354741079903994 |
        ...
        Then I should get the object response message matches with
            | response                                                                                                                    |
            | {"Addititional": "Cafe-automation", "Note":"Automation Test Driver App" , "buttonCall": "Call", "buttonOnMyWay": "Pick up"} |

    Scenario: 04. Check case verify phone number passenger when touch button Call
        Given Waiting open driver app succesfull
        And I want to register other account from app
            | platform | number     | country | appType   | verifyCode | ime             |
            | android  | 2055550001 | US      | passenger | 1211       | 354741079903994 |
    ...
    Scenario: 07. Check case verify info flight info with booking to airport
        Given Waiting open driver app succesfull
        And I want to register other account from app
            | platform | number     | country | appType   | verifyCode | ime             |
            | android  | 2055550001 | US      | passenger | 1211       | 354741079903994 |
    ...
    Scenario: 08. Check case verify verify content popup confirmation when touch button PickUp
        Given Waiting open driver app succesfull
        And I want to register other account from app
            | platform | number     | country | appType   | verifyCode | ime             |
            | android  | 2055550001 | US      | passenger | 1211       | 354741079903994 |
        ...
        And I want to get message confirmation status Arrived and Wating
        Then I should get the response message matches with language
            | response                                         |
            | {"en":"Confirm pick-up Automation Customer 01?"} |

    Scenario: 09. Check case verify status driver when touch button PickUp
        Given Waiting open driver app succesfull
        And I want to register other account from app
            | platform | number     | country | appType   | verifyCode | ime             |
            | android  | 2055550001 | US      | passenger | 1211       | 354741079903994 |
    ...
    Scenario: 19. Check case verify form SOS
        Given Waiting open driver app succesfull
        And I want to login webbooking with data
            | number     | country | password     |
            | 2055550003 | US      | passwordQup1 |
        ...
        And I want to Accepted booking
        And I want to open form Arrived and Waiting
        When I want to open form SOS in screen Arrived and waiting
